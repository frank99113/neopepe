...
`;
      ...
      function L() {
        ...
        return {
          ...
          ConnectingSocial: P.U.state.socialProvider
      ...
      let Z = class extends i.WF {
        constructor() {
          super(),
            ...
            (this.networkImage = T.$.getNetworkImage(this.network)),
            (this.showBack = !1),
    ...
    `;
        ...
        onWalletHelp() {
          R.E.sendEvent({ type: "track", event: "CLICK_WALLET_HELP" }),
    ...
    ></wui-icon-link>`;
        ...
        onNetworks() {
          this.isAllowedNetworkSwitch() &&
            (R.E.sendEvent({ type: "track", event: "CLICK_NETWORKS" }),
            p.I.push("Networks"));
        }
...
`;
    ...
    ></wui-icon-box>`;
      ...
      (K.styles = [v.W5, U]),
        F([(0, r.MZ)()], K.prototype, "backgroundColor", void 0),
        F([(0, r.MZ)()], K.prototype, "iconColor", void 0),
        F([(0, r.MZ)()], K.prototype, "icon", void 0),
        F([(0, r.MZ)()], K.prototype, "message", void 0),
        F([(0, r.MZ)()], K.prototype, "loading", void 0),
        F([(0, r.MZ)()], K.prototype, "iconType", void 0),
        (K = F([(0, y.E)("wui-snackbar")], K));
      let Y = (0, i.AH)`
  :host {
    display: block;
    position: absolute;
    ...
    `),
        ...
        async onNewAddress(e) {
          let t = c.W.state.isSwitchingNamespace,
            o = !b.w.getPlainAddress(this.caipAddress),
            i = b.w.getPlainAddress(e);
          "ProfileWallets" !== p.I.state.view &&
            (i || t || this.enableEmbedded
              ? t && i && !this.enableEmbedded
                ? p.I.goBack()
                : this.enableEmbedded && o && i && l.W.close()
              : l.W.close()),
        ...
        onNewNetwork(e) {
          let t = this.caipNetwork,
            ...
            u = "ProfileWallets" === p.I.state.view,
            w = !c.W.getAccountData(e?.chainNamespace)?.caipAddress,
            g = "UnsupportedChain" === p.I.state.view,
            m = l.W.state.open,
            b = !1;
          this.enableEmbedded && "SwitchNetwork" === p.I.state.view && (b = !0),
            m &&
              !h &&
              !u &&
              (w
                ...
                ? (b = !0)
                : n && i === a && !d && (b = !0)),
            b && "SIWXSignMessage" !== p.I.state.view && p.I.goBack(),
            (this.caipNetwork = e);
        }
        prefetch() {
          this.hasPrefetched ||
...
`;
      ...
      (c.styles = [a.W5, a.ck, n]),
        ...
        l([(0, r.MZ)()], c.prototype, "size", void 0),
        l([(0, r.MZ)()], c.prototype, "objectFit", void 0),
